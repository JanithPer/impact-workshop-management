...
export function DateTimePicker() {
  ...
  function handleDateSelect(fieldName: "startTime" | "endTime", date: Date | undefined) {
    if (date) {
                          ...
                          {Array.from({ length: 24 }, (_, i) => i)
                            ...
                            .map((hour) => (
                              <Button
                                ...
                                className="sm:w-full shrink-0 aspect-square"
                                onClick={() =>
                                  handleTimeChange("endTime", "hour", hour.toString())
                                }
                              >
                                {hour}
                              </Button>
                          ...
                          {Array.from({ length: 12 }, (_, i) => i * 5).map(
                            (minute) => (
                              <Button
                                ...
                                className="sm:w-full shrink-0 aspect-square"
                                onClick={() =>
                                  handleTimeChange("endTime", "minute", minute.toString())
                                }
                              >
                                {minute.toString().padStart(2, "0")}
                              </Button>
